   ...
   # url(r'^settings/password/$', core_views.password, name='password'),
        url(r'^oauth/', include('social_django.urls', namespace='social')),
               ...
               # path('payment_method/',views.payment_method,name="payment_method"),
                ...
                path("joblev/",views.joblev,name='joblev'),
                path("jobshift/",views.jobshift,name='jobshift'),
                path("curren/",views.curren,name='curren'),
                path("jobexperiences/",views.jobexperiences,name='jobexperiences'),
